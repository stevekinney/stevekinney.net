...
modified: 2024-03-18T12:20:28-06:00
---
...
Variants let you group similar components (like buttons with different styles) into one master component. This makes it easier to manage and choose the right version of a component from the Assets panel.

## Updating and Maintaining Components

When you update a master component, all instances get that update too, making it simple to make changes. If you no longer need a component, you can detach its copies to edit them separately from the component structure.
