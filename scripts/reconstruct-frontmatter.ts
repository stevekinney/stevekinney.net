...
function deriveTitle(data: FrontmatterData, content: string, filePath: string): string {
...
function deriveDescription(data: FrontmatterData, content: string): string | undefined {
...
async function processFile(rel: string): Promise<boolean> {
