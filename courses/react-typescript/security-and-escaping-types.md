...
description: 'Brand strings in TypeScript as trusted/untrusted, then enforce sanitizer boundaries before rendering user or API HTML to prevent unsafe DOM injection.'
---
