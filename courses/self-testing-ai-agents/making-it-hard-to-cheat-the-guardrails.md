...
description: 'Layer command restrictions, protected configuration, CI checks, and merge rules so coding agents cannot bypass quality gates by skipping Git hooks.'
---
