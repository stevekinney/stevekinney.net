...
description: 'Walk through a security review checklist that covers IAM policies, S3 bucket access, CloudFront settings, Lambda permissions, API Gateway authentication.'
---
