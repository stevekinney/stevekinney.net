...
In Module 1, you attached IAM policies to users, groups, or roles. Those policies travel with the identity: "This user is allowed to do these things." A bucket policy is the reverse — it attaches to the resource and says: "These people are allowed to do things to me."
...
Your IAM user from Module 1 can already access this bucket through IAM policies. The bucket policy adds public access on top of that. Both mechanisms work together:
