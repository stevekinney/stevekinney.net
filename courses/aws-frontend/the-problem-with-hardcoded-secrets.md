...
You built a Lambda function in Module 7 and connected it to a DynamoDB table in [Connecting DynamoDB to Lambda](connecting-dynamodb-to-lambda.md). The table name went into an environment variable, and that was fine — a table name isn't a secret.
