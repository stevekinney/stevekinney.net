...
description: 'Build GitHub Actions workflows with jobs, triggers, reusable actions, caching, deployment controls, and careful handling of permissions and secrets.'
---
