...
> [!NOTE] Why pnpm alone isn't enough
...
> [!IMPORTANT] The `^` prefix is the most important concept in Turborepo
...
> [!IMPORTANT] Turborepo rebuilds dependents, not just the changed package
...
> [!NOTE] The graph is the architecture
