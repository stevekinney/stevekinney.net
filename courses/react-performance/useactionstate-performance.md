...
description: 'Use React 19 useActionState to centralize form mutation state (pending, success, error) and replace scattered loading/error handlers with one lifecycle flow.'
---
