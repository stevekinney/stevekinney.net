...
- [Using Snippets](vscode-snippets.md) ([Exercises](vscode-snippet-exercises.md))
...
- [Built-in Problem Matchers](built-in-problem-matchers.md)
...
- [More on Multi-Root Namespaces](more-on-multi-root-namespaces.md)

## Dev Containers

- [Dev Containers](vscode-dev-containers.md)
- [Setting Up Dev Containers](setting-up-dev-containers.md)
...
- [Building a Simple Extension](building-a-simple-vscode-extension.md)
- [Building an Extension with a Web View](vscode-regular-expressionist.md)

## Appendix

- [Some Keyboard Shortcuts](vscode-keyboard-shortcuts.md)
