...
- [Multiple Cursors with Find and Replace](multiple-cursors-with-find-and-replace)
- [Refactoring](refactoring-in-vscode.md)
- [Emmet](vscode-emmet.md)
- [Steve's Favorite and Other Popular Extensions](favorite-vs-code-extensions)
## Settings
...
- [Using Snippets](vscode-snippets) ([Exercises](vscode-snippets-exercises.md))
...
- [Github Codespaces](github-codespaces-vscode.md)
