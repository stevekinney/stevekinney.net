...
Ever tried to use a JavaScript library in TypeScript only to get the dreaded "Could not find a declaration file" error? Or wondered how to properly organize your TypeScript code across files? Understanding modules and declaration files is crucial for working with external libraries and building maintainable TypeScript applications. Let's demystify these concepts.

## Module Systems in TypeScript

TypeScript supports multiple module systems. Here's what you need to know:
...
export default class ScientificCalculator implements Calculator {
...
// main.ts - Importing
import ScientificCalculator, { add, PI, Calculator } from './math';
import * as math from './math';
import type { Calculator as CalcType } from './math'; // Type-only import
...
// main.ts - CommonJS import
const math = require('./math');
import math = require('./math'); // TypeScript style

// With types
import { Calculator } from './types';
const calc: Calculator = require('./calculator');
```

### Module Resolution

TypeScript resolves modules in two ways:
...
// tsconfig.json
{
  "compilerOptions": {
    ...
    // Node - follows Node.js resolution (recommended)
    "moduleResolution": "node",

    // Node16/NodeNext - for modern Node.js with ESM
    "moduleResolution": "node16",

    // Bundler - for use with bundlers like Vite, webpack
...
// 4. ./node_modules/lodash/package.json "types" field
